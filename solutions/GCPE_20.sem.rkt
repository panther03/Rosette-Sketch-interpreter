...
(synthesize
#:forall (list)
#:guarantee (assert (and (equal? (Start.Sem (sol) 1 1 9 9 9 9 9) True) (equal? (Start.Sem (sol) 2 1 2 9 9 9 9) True) (equal? (Start.Sem (sol) 3 1 2 1 9 9 9) True) (equal? (Start.Sem (sol) 4 1 2 1 2 9 9) True) (equal? (Start.Sem (sol) 5 1 2 1 2 1 9) True) (equal? (Start.Sem (sol) 6 1 2 1 2 1 2) True) (equal? (Start.Sem (sol) 1 0 9 9 9 9 9) False) (equal? (Start.Sem (sol) 2 0 3 9 9 9 9) False) (equal? (Start.Sem (sol) 3 3 3 0 9 9 9) False) (equal? (Start.Sem (sol) 4 0 3 3 3 9 9) False) (equal? (Start.Sem (sol) 4 3 3 0 3 9 9) False) (equal? (Start.Sem (sol) 5 0 3 3 3 3 9) False) (equal? (Start.Sem (sol) 5 3 3 0 3 3 9) False) (equal? (Start.Sem (sol) 5 3 3 3 3 0 9) False) (equal? (Start.Sem (sol) 6 3 3 3 3 0 3) False)))))
