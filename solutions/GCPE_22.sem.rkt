...
(synthesize
#:forall (list)
#:guarantee (assert (and (equal? (Start.Sem (sol) 2 0 0 9 9) True) (equal? (Start.Sem (sol) 2 0 1 9 9) True) (equal? (Start.Sem (sol) 2 1 1 9 9) True) (equal? (Start.Sem (sol) 3 2 0 0 9) True) (equal? (Start.Sem (sol) 3 2 0 1 9) True) (equal? (Start.Sem (sol) 3 2 1 1 9) True) (equal? (Start.Sem (sol) 4 2 2 0 0) True) (equal? (Start.Sem (sol) 4 2 2 0 1) True) (equal? (Start.Sem (sol) 4 2 2 1 1) True) (equal? (Start.Sem (sol) 1 3 9 9 9) False) (equal? (Start.Sem (sol) 2 1 0 9 9) False) (equal? (Start.Sem (sol) 3 3 1 0 9) False) (equal? (Start.Sem (sol) 4 3 3 1 0) False)))))
