...
(synthesize
#:forall (list)
#:guarantee (assert (and (equal? (Start.Sem (sol) 1 0 9 9 9 9 9) True) (equal? (Start.Sem (sol) 1 1 9 9 9 9 9) True) (equal? (Start.Sem (sol) 2 0 1 9 9 9 9) True) (equal? (Start.Sem (sol) 2 1 0 9 9 9 9) True) (equal? (Start.Sem (sol) 3 1 0 1 9 9 9) True) (equal? (Start.Sem (sol) 3 0 1 0 9 9 9) True) (equal? (Start.Sem (sol) 4 1 0 1 0 9 9) True) (equal? (Start.Sem (sol) 4 0 1 0 1 9 9) True) (equal? (Start.Sem (sol) 5 1 0 1 0 1 9) True) (equal? (Start.Sem (sol) 2 0 0 9 9 9 9) False) (equal? (Start.Sem (sol) 2 1 1 9 9 9 9) False) (equal? (Start.Sem (sol) 3 0 1 1 9 9 9) False) (equal? (Start.Sem (sol) 3 0 0 1 9 9 9) False) (equal? (Start.Sem (sol) 3 1 1 0 9 9 9) False) (equal? (Start.Sem (sol) 4 1 0 0 1 9 9) False) (equal? (Start.Sem (sol) 6 1 0 1 1 0 1) False) (equal? (Start.Sem (sol) 6 0 1 0 0 1 0) False)))))
