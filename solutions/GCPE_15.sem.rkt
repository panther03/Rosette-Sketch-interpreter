...
(synthesize
#:forall (list)
#:guarantee (assert (and (equal? (Start.Sem (sol) 2 2 2 9 9) True) (equal? (Start.Sem (sol) 3 2 2 2 9) True) (equal? (Start.Sem (sol) 4 2 2 2 2) True) (equal? (Start.Sem (sol) 1 0 9 9 9) False) (equal? (Start.Sem (sol) 1 1 9 9 9) False)))))
